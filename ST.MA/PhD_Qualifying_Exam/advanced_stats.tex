...
\subsection{NP Test}
 (Steps)
\circled{1} Find joint distribution $f(X_1, \cdots, X_n)$ - MLR/NEF
\circled{2} Hypothesis $H_0, H_1$ - simple/composite, must be $\theta$ and not $f(\theta)$
\circled{3} Form N-P test structure $T_*$
\circled{4} Find test dist, rejection/acceptance region.
\compact
